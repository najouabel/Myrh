...
import com.app.myrhh.dto.OfferRequest;
import com.app.myrhh.models.Offer;
import com.app.myrhh.services.OfferService;
...
public class OfferController {
    ...
    public ResponseEntity<String> saveOffer(@RequestBody OfferRequest req){
        Offer offer = new Offer(req.getTitle(), req.getDescription(), req.getLocation(), req.getDegree(), req.getSalary(), req.getProfile(), Long.valueOf(req.getCompanyId()));
